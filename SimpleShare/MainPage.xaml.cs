...
using SimpleShare.Helpers;
using SimpleShare.Helpers.Composition;
using SimpleShare.Helpers.Composition.ImageLoader;
...
namespace SimpleShare
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            var shadow = (sender as FrameworkElement).FindChildren<SimpleShare.Helpers.Composition.CompositionShadow>().FirstOrDefault();
        ...
        private void SetupCompositionImage(CompositionImage image, SimpleShare.Helpers.Composition.CompositionShadow shadow)
        {
        ...
        private void Timeline_ItemInvoked(object sender, EventArgs e)
        {
